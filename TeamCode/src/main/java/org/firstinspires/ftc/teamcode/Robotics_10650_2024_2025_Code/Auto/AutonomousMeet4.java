...
public class AutonomousMeet4 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
       ...
       // robot.extenderToPos(890, 0.8,false);
        ...
        robot.executeMoveAlt(-1015, 145, 0, 2500, false, 860, 600, 1, 1, true); //First position again
        ...
        robot.pitch.setPosition(BASKET_PITCH_POS);
        robot.executeMoveAlt(-1011, -70, 0, 3000, false, 860, 600,1,2, false); //First position again
